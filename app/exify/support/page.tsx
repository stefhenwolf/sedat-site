...
export const metadata: Metadata = {
  title: "Exify Support",
  description: "Support information for Exify Photo Frames.",
};

export default function ExifySupportPage() {
  return (
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-8">
        ...
        <section className="glass-panel soft-ring rounded-[2rem] px-6 py-8 sm:px-8 sm:py-10">
          ...
          <h1 className="font-display mt-5 text-4xl tracking-[-0.04em] sm:text-5xl">
            Need help with Exify Photo Frames?
          </h1>
          <p className="mt-6 max-w-2xl text-base leading-8 text-foreground/72">
            For support questions, purchase issues, restore purchase requests,
            bug reports, or feature ideas, reach out directly and include as
            much context as possible so we can help quickly.
          </p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="rounded-[1.4rem] border border-border bg-surface-strong p-5">
              ...
              <a
                href="mailto:setadpala@gmail.com?subject=Exify%20Support"
            ...
            <div className="rounded-[1.4rem] border border-border bg-surface-strong p-5">
              ...
              <p className="mt-3 text-lg font-semibold">
                Support, premium issues, bugs, product feedback
              </p>
            </div>
          </div>
        </section>
